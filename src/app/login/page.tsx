      ...
      <div className="w-full max-w-md relative z-10">
        <div className="group bg-slate-900/70 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] border border-slate-700/60 p-10 flex flex-col items-center opacity-80 transition-opacity duration-300 ease-out hover:opacity-100 focus-within:opacity-100">
          ...
          <div className="mt-8 pt-6 border-t border-slate-700/50 w-full flex flex-col items-center space-y-4">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-blue-400 hover:text-blue-300 transition-colors flex items-center space-x-2 rounded-full px-2 py-1">
            ...
            <div className="flex items-center space-x-4 pt-4">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:bg-slate-700 transition-all border border-slate-700">
