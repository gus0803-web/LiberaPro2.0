...
export default function LoginPage() {
  ...
  return (
    <div 
      className="min-h-screen flex items-center justify-center p-4 bg-cover bg-center bg-no-repeat md:bg-[length:100vw_auto] md:bg-top bg-[#0A1612]"
    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-black/40 backdrop-blur-md rounded-[2.5rem] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] border border-white/10 p-10 flex flex-col items-center">
          {/* LiberaPro Logo */}
          <div className="mb-6 relative w-24 h-24 transform-gpu transition-transform duration-300 hover:-translate-y-1">
            <Image src="/logo-pluma.png" alt="LiberaPro Logo" fill sizes="6rem" className="object-contain object-center" />
          </div>

          <h1 className="text-4xl font-bold text-white tracking-tight mb-2">LiberaPro</h1>
          <p className="text-xs font-bold text-slate-300 text-center mb-8 uppercase tracking-widest max-w-xs">
            MAESTROS MODERNOS LIDEREANDO LA EDUCACIÓN EN MÉXICO
          </p>

          {error && (
            <div className="w-full bg-red-50/90 text-red-600 border border-red-200 p-3 rounded-xl text-sm mb-6 text-center font-bold">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-5 py-4 rounded-xl bg-white/80 backdrop-blur-sm border-none focus:ring-2 focus:ring-blue-500 transition-all text-slate-900 font-bold placeholder:text-slate-500 shadow-inner"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 mt-4 bg-blue-600/90 hover:bg-blue-600 text-white font-bold rounded-xl shadow-lg transition-all transform hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed backdrop-blur-sm"
            >
          ...
          <div className="mt-8 pt-6 border-t border-slate-700/50 w-full flex flex-col items-center space-y-4">
            ...
            <div className="flex items-center space-x-4 pt-4">
              ...
              <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:bg-slate-700 transition-all border border-slate-700">
              ...
              <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:bg-slate-700 transition-all border border-slate-700">
