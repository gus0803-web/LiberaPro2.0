    ...
    <footer className="shrink-0 border-t border-white/20 px-4 sm:px-8 py-4">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-300">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/terms" className="hover:text-white transition-colors underline-offset-2 hover:underline">
            {isEs ? 'Términos de Uso' : 'Terms of Use'}
          </Link>
          <span className="text-slate-400">|</span>
          <Link href="/contact" className="hover:text-white transition-colors underline-offset-2 hover:underline">
      ...
      <p className="mt-2 text-[10px] text-slate-400/80 text-center leading-relaxed max-w-4xl mx-auto">
        {isEs
